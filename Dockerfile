...
RUN WASM_BUILD_WORKSPACE_HINT=$PWD cargo install contracts-node --git https://github.com/Supercolony-net/substrate-contracts-node --branch feature/pallet-assets-chain-extension --force --locked
