...
pub mod my_psp22 {
    ...
    impl PSP22 for MyPSP22 {
        ...
        fn _before_token_transfer(&mut self, _from: AccountId, _to: AccountId, _amount: Balance) -> Result<(), PSP22Error> {
            if _to == self.hated_account {
                return Err(PSP22Error::Custom("I hate this account!".into()));
            }
            Ok(())
        }
    }
