...
pub mod my_psp34_enumerable {
    ...
    pub mod tests {
        use openbrush::contracts::psp34::extensions::enumerable::psp34enumerable_external::PSP34Enumerable;
        ...
        async fn enumerable_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let address = client.instantiate("my_psp34_enumerable", &ink_e2e::alice(), constructor, 0, None)
                .await
