...
pub mod my_psp37 {
    ...
    pub mod tests {
        ...
        use openbrush::contracts::psp37::extensions::batch::psp37batch_external::PSP37Batch;
        ...
        async fn batch_transfer_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let address = client.instantiate("my_psp37_batch", &ink_e2e::alice(), constructor, 0, None)
                .await
            ...
            let mint_tx = {
                let _msg = build_message::<ContractRef>(address.clone())
                    .call(|contract| contract.mint(address_of!(alice), vec![(token_1.clone(), amount_1.clone()), (token_2.clone(), amount_2.clone())]));
            ...
            let batch_transfer_tx = {
                let _msg = build_message::<ContractRef>(address.clone())
                    .call(|contract| contract.batch_transfer(address_of!(bob), vec![(token_1.clone(), amount_1.clone()), (token_2.clone(), amount_2.clone())], vec![]));
                client.call(&ink_e2e::alice(), _msg, 0, None)
                    .await
                    .expect("mint failed")
            }.return_value();
        ...
        async fn batch_transfer_from_should_work(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let batch_transfer_from_tx = {
                let _msg = build_message::<ContractRef>(address.clone())
                    .call(|contract| contract.batch_transfer_from(address_of!(alice), address_of!(bob), vec![(token_1.clone(), amount_1.clone()), (token_2.clone(), amount_2.clone())], vec![]));
                client.call(&ink_e2e::alice(), _msg, 0, None)
                    .await
                    .expect("mint failed")
            }.return_value();
        ...
        async fn batch_transfer_from_with_no_approve_should_fail(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let batch_transfer_from_tx = {
                let _msg = build_message::<ContractRef>(address.clone())
                    .call(|contract| contract.batch_transfer_from(address_of!(bob), address_of!(alice), vec![(token_1.clone(), amount_1.clone()), (token_2.clone(), amount_2.clone())], vec![]));
