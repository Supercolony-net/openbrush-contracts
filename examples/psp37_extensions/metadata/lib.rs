...
pub mod my_psp37 {
    ...
    pub mod tests {
        ...
        async fn metadata_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let address = client.instantiate("my_psp37_metadata", &ink_e2e::alice(), constructor, 0, None)
                .await
            ...
            let set_attribute_tx = {
                let _msg = build_message::<ContractRef>(address.clone())
                    .call(|contract| contract.set_attribute(id.clone(), attr.clone(), String::from("https://www.727.ventures/")));
